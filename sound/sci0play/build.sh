...
wlink option quiet system dos file build/sciplay.obj,build/timer.obj,build/driver.obj,build/serial.obj,build/sio.obj option eliminate name build/sciplay.exe
