...
wlink option quiet system dos file build/sciplay.obj,build/timer.obj,build/driver.obj,build/sound.obj,build/video.obj,build/util.obj option eliminate name build/sciplay.exe
