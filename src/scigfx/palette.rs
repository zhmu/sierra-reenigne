...
pub fn fill_ega_colours(palette: &mut [u8; 768]) {
    set_palette_rgb(palette,   0, 0x00, 0x00, 0x00);
    set_palette_rgb(palette,   1, 0x00, 0x00, 0xAA);
    set_palette_rgb(palette,   2, 0x00, 0xAA, 0x00);
    set_palette_rgb(palette,   3, 0x00, 0xAA, 0xAA);
    set_palette_rgb(palette,   4, 0xAA, 0x00, 0x00);
    set_palette_rgb(palette,   5, 0xAA, 0x00, 0xAA);
    set_palette_rgb(palette,   6, 0xAA, 0x55, 0x00);
    set_palette_rgb(palette,   7, 0xAA, 0xAA, 0xAA);
    set_palette_rgb(palette,   8, 0x55, 0x55, 0x55);
    set_palette_rgb(palette,   9, 0x55, 0x55, 0xFF);
    set_palette_rgb(palette,  10, 0x55, 0xFF, 0x55);
    set_palette_rgb(palette,  11, 0x55, 0xFF, 0xFF);
    set_palette_rgb(palette,  12, 0xFF, 0x55, 0x55);
    set_palette_rgb(palette,  13, 0xFF, 0x55, 0xFF);
    set_palette_rgb(palette,  14, 0xFF, 0xFF, 0x55);
    set_palette_rgb(palette,  15, 0xFF, 0xFF, 0xFF);
    for n in 16..256 {
